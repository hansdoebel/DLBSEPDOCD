...
Die Webapp (Frontend, Backend, Tests), Infrastruktur und Konfiguration (Docker Compose, CI/CD-Pipeline, FluxCD-Setup, Kubernetes-Manifeste, Monitoring) wurden mit KI-Unterstützung erstellt ([Claude Code Opus 4.6](https://claude.com/product/claude-code)). 

Die Architekturentscheidungen und die Auswahl der eingesetzten Services (Forgejo, Woodpecker CI, Harbor, FluxCD, Prometheus, Grafana) sowie deren Zusammenspiel wurden eigenständig getroffen.
